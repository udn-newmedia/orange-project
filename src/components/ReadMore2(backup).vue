<template>
  <div class="read-more-background">
    <div 
      :id="menuText" 
      class="ReadMoreWrapper" 
      :class="titlePosition" 
      :style="{backgroundColor: backgroundColor, color: fontColor, backgroundImage: 'url('+ bgRWD() +')'}">
      <div 
        class="title" 
        :style="{backgroundColor: titleColor}" 
        :class="{theShadow: useShadow}">
        <div class="title-up"><h3>{{title}}</h3></div>
        <div class="title-bottom"><h2>{{subtitle}}</h2></div>
